...
export default function Login() {
  return (
    <div className="relative flex h-full flex-col justify-center p-6 text-center">
      ...
      <ShootingStar weight="duotone" className="mx-auto size-8 text-blue-700" />
      ...
      <div className="mt-2 space-y-3 text-left">
        <div className="flex items-center gap-2">
          ...
          <div className="min-w-0 flex-1">
            ...
            <p className="text-xs text-gray-600">This is how you'll log in.</p>
          </div>
        </div>
        <div className="flex items-center gap-2">
          <div className="grid size-12 flex-none place-items-center">
          ...
          <div className="min-w-0 flex-1">
            <p className="font-medium leading-snug">A super-secret password</p>
