  ...
  return (
    <>
      ...
      <div className="space-y-6 p-6">
        <section>
          <h2 className="text-xl font-bold tracking-tight">Your medication</h2>
            ...
            <div className="flex gap-3 rounded-md border border-gray-300 bg-white p-2 shadow-sm">
              ...
              <div className="flex min-w-0 flex-1 flex-col justify-center">
                ...
                <div className="mt-1 flex items-center gap-1.5">
                  ...
                  <span className="text-lg font-semibold leading-none">0</span>
            ...
            <div className="flex gap-3 rounded-md border border-gray-300 bg-white p-2 shadow-sm">
              ...
              <div className="flex min-w-0 flex-1 flex-col justify-center">
                ...
                <div className="mt-1 flex items-center gap-1.5">
                  ...
                  <span className="text-lg font-semibold leading-none">3</span>
                  <PlusCircle className="size-6 text-emerald-600 transition active:scale-95 active:opacity-75" />
                </div>
